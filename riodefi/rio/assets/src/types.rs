...
define_enum!(
    #[derive(PartialEq, Eq, Ord, PartialOrd, Clone, Copy, Encode, Decode, RuntimeDebug, scale_info::TypeInfo)]
...
bitmask! {
    ...
    #[cfg_attr(not(feature = "std"), derive(RuntimeDebug, scale_info::TypeInfo))]
    #[cfg_attr(feature = "std", derive(Deserialize, Serialize, scale_info::TypeInfo))]
